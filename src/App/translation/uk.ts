	...
	summary: {
		...
		description: {
			...
			part4List: {
				...
				list5: 'Окремим пет-проєктом, яким зараз користуються мої друзі та над котрим я багато експериментую, пробую додаткові технології та відточую навички які вже маю.',
			},
